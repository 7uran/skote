          ...
          <li className='group'>
            ...
            {activeSection === 'Dashboards' && (
              <div className='transition-all duration-300 overflow-hidden text-gray-500 py-2 text-xs flex flex-col gap-2'>
                ...
                <p className='hover:text-white transition ml-6 cursor-pointer'>Blog</p>
                <p className='hover:text-white transition ml-6 cursor-pointer'>Job</p>
              </div>
            )}
          </li>
