    ...
    <div className='w-full p-6 text-white flex flex-col gap-4 min-h-screen'>
      ...
      <div className='bg-elementsColor rounded'>
        <div className='flex px-4 py-6 justify-between'>
          <input placeholder='Search your job' className='placeholder-textColor w-[35%] text-white bg-elementsColor border rounded border-borderColor text-xs p-2' />
          <input placeholder='San Francisco,LA' className='placeholder-textColor w-[15%] text-white bg-elementsColor border rounded border-borderColor text-xs p-2' />
          <input placeholder='Job Categories' className='placeholder-textColor w-[15%] text-white bg-elementsColor border rounded border-borderColor text-xs p-2' />
